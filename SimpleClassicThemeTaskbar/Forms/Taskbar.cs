            ...
            while (!selfClose)
            {
                ...
                else
                {
                    ...
                    if (NeverShow)
                        ...
                        Invoke(new Action(() => { Visible = !(full && wnd.ClassName != "Progman" && wnd.ClassName != "WorkerW"); }));
                }
		...
		{   
            ...
            if (heldDownButton != null)
            {
                ...
                if ((MouseButtons & MouseButtons.Left) != 0)
                {
                    ...
                    newIcons.Remove(heldDownButton);
                    newIcons.Insert(Math.Min(newIcons.Count, newIndex), heldDownButton);
            ...
            //Clear the saved list and add all items from the newly generated and ordered list
            icons.Clear();
            foreach (BaseTaskbarProgram program in programs)
                icons.Add(program);
