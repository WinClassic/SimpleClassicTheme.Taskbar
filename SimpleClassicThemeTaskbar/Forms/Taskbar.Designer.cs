...
namespace SimpleClassicThemeTaskbar
{
    partial class Taskbar
    {
        ...
        private void InitializeComponent()
        {
			...
			this.systemTray1 = SimpleClassicThemeTaskbar.Helpers.Config.Instance.EnablePassiveTray ? new UIElements.SystemTray.SystemTray() : new UIElements.OldSystemTray.SystemTray();
