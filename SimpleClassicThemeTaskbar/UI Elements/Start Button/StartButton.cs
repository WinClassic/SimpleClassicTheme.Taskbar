...
namespace SimpleClassicThemeTaskbar
{
    public partial class StartButton : UserControl
    {
        ...
        private void StartButton_ParentChanged(object sender, EventArgs e)
        {
            if (Parent != null)
                label1.Font = new Font(Parent.Font.FontFamily, label1.Font.SizeInPoints, FontStyle.Bold);
        }
    }
}
