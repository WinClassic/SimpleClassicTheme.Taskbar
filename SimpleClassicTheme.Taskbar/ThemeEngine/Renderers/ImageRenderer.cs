    ...
    class ImageRenderer : BaseRenderer
    {
        ...
        public ImageRenderer(string resourceDirectory)
        {
            ...
            if (true)
            {
                ...
                if (!int.TryParse(tH, out taskbarHeight))
                ...
                if (!int.TryParse(tmW, out taskbuttonMinimalWidth))
                ...
                if (!int.TryParse(ttL.Split(',')[0], out taskbuttonTextureLocation.Item1) ||
                    !int.TryParse(ttL.Split(',')[1], out taskbuttonTextureLocation.Item2))
                ...
                if (!int.TryParse(tlbL.Split(',')[0], out taskbuttonLeftBorderLocation.Item1) ||
                    !int.TryParse(tlbL.Split(',')[1], out taskbuttonLeftBorderLocation.Item2))
                ...
                if (!int.TryParse(trbL.Split(',')[0], out taskbuttonRightBorderLocation.Item1) ||
                    !int.TryParse(trbL.Split(',')[1], out taskbuttonRightBorderLocation.Item2))
                ...
                if (!int.TryParse(tgwbS, out taskbuttonGroupWindowBorderSize))
                ...
                if (!int.TryParse(tgwtrS.Split(',')[0], out taskbuttonGroupWindowTaskbuttonRealSize.Left) ||
                    !int.TryParse(tgwtrS.Split(',')[1], out taskbuttonGroupWindowTaskbuttonRealSize.Top) ||
                    !int.TryParse(tgwtrS.Split(',')[2], out taskbuttonGroupWindowTaskbuttonRealSize.Right) ||
                    !int.TryParse(tgwtrS.Split(',')[3], out taskbuttonGroupWindowTaskbuttonRealSize.Bottom))
                ...
                if (!int.TryParse(sbW, out startButtonWidth))
                ...
                if (!int.TryParse(stbW, out systemTrayBaseWidth))
                ...
                if (!int.TryParse(stfiP.Split(',')[0], out systemTrayFirstIconPosition.Item1) ||
                    !int.TryParse(stfiP.Split(',')[1], out systemTrayFirstIconPosition.Item2))
        ...
        private static bool ParseColor(string text, out Color c)
        {
            ...
            if (match != null)
            {
                ...
                c = Color.FromArgb(int.Parse(color.Substring(1, 2)),
                    int.Parse(color.Substring(3, 2)),
                    int.Parse(color.Substring(5, 2)));
                return true;
            }
            c = Color.Transparent;
            return false;
